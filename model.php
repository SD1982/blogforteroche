...
function getComments($postId)
{
    ...
    $db = dbConnect();
    $comments = $db->prepare('SELECT author, comment_content, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin%ss\') AS comment_date_fr FROM commentaires WHERE posts_id = ? ORDER BY comment_date');
